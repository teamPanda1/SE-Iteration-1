...
public class ProfileFrame extends JFrame implements ActionListener{
    ...
    public ProfileFrame() {
        ...
        JLabel lblNewLabel_1 = new JLabel("Favortite Car");
        ...
        okButton.setBounds(500, 525, 80, 40);
        ...
        */
        ...
        payButton.setBounds(200, 525, 80, 40);
	...
	public void actionPerformed(ActionEvent e) {
    	if(e.getSource() == okButton) {
    		frame.dispose();
    		CarListFrame frame1 = null;
			try {
				frame1 = new CarListFrame();
